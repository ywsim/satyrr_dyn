function robot = planar_4_dof_monoped()
%% Description & Init
...
robot.name = '4 DOF 4-Link Planar Monoped';
robot.base = 'fixed';
robot.drive = 'serial';
robot.dimensions = 'planar';
robot.nd = 4;   % number of DoF
